...
class Draw:
    ...
    _bg = cv2.resize(cv2.imread(os.path.join(os.path.dirname(__file__), "res/rus_white_short_lp.png")), (440, 95))
...
if __name__ == "__main__":
    ...
    parser.add_argument("plate", help="license plate number (default: A000AA00)", type=str, nargs="?", default="B202BX70")

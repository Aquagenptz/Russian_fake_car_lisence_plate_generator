...
class Draw:
    ...
    _bg = cv2.resize(cv2.imread(os.path.join(os.path.dirname(__file__), "res/rus_red_lp.png")), (440, 95))
    ...
    def _draw_fg(self, plate):
        ...
        img[0:95, offset:offset + 45] = self._draw_char(plate[5], 0, 29)
        offset = offset + 65
...
if __name__ == "__main__":
    ...
    parser.add_argument("plate", help="license plate number (default: A000AA00)", type=str, nargs="?", default="148CD277")
